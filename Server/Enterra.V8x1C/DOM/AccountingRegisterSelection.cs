...
{
    /// <summary>
    /// РегистрБухгалтерииВыборка (AccountingRegisterSelection)
    /// </summary>
    public class AccountingRegisterSelection : BaseSessionObject
    {
        internal AccountingRegisterSelection(Session session, object ptr)
            : base(session, ptr)
        {
        }
